    ...
    >
      ...
      <div className="mb-10" aria-labelledby="about-history">
        <div className="rounded-2xl shadow-lg"
          ...
          <h3 id="about-history" className="text-2xl font-bold mb-3" style={{color:'var(--color-point)', lineHeight:'1.15'}}>연혁</h3>
          <ul className="list-disc pl-6" style={{color:'var(--color-text-sub)', lineHeight:'1.35'}}>
